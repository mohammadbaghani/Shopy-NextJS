...
function ProductDetailPage(props) {
    ...
    const [noimage, setNoimage] = useState('tem-child right--image ');
    const [menimg, setMenimg] = useState('menimg blackmenimg ');
    const [womenimg, setWomenimg] = useState('womenimg ');
    const [menbutton, setMenbutton] = useState('tem-child center-image siah-image');
    ...
    // const [currentcolor, setCurrentcolor] = useState(loadedProduct.text);
